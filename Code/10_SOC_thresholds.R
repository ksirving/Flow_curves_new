...
write.csv(all_csci_sub, "output_data/09a_SOC_all_csci_sub.csv") 
...
write.csv(all_asci_sub, "output_data/09a_SOC_all_asci_sub.csv") 
...
# write out df to csv  
write.csv(df, "output_data/09a_SOC_ASCI_delta_thresholds_scaled.csv")
...
df
#write out df to csv 
write.csv(df, "output_data/09a_SOC_CSCI_delta_thresholds_scaled.csv") 

# Combine data ------------------------------------------------------------

asci <- read.csv("output_data/09a_SOC_ASCI_delta_thresholds_scaled.csv")
csci <- read.csv("output_data/09a_SOC_CSCI_delta_thresholds_scaled.csv")

delta <- rbind(asci, csci)

write.csv(delta, "output_data/09a_SOC_ALL_delta_thresholds_scaled.csv") 
